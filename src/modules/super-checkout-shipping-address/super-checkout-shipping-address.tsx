...
import { ISuperCheckoutShippingAddressProps } from './super-checkout-shipping-address.props.autogenerated';

export interface IProps extends ISuperCheckoutShippingAddressProps<ISuperCheckoutShippingAddressData>, IModuleStateProps {}
 ...
 *
 * Address component
 * @extends {React.Component<ISuperCheckoutShippingAddressProps<ISuperCheckoutShippingAddressData>>}
 */
// @ts-ignore
@withModuleState
@observer
class CheckoutShippingAddress extends React.Component<IProps> {
    ...
    private _canShip = (): boolean => {
        ...
        return checkout.result.checkoutCart.cart.CartLines.some(
            cartLine => cartLine.DeliveryMode !== request.channel?.PickupDeliveryModeCode // .channel.PickupDeliveryModeCode
        );
    };
